...
namespace PaymentGateway.UnitTests.Services
{
    ...
    class PaymentServiceTests
    {
        ...
        [Test]
        //Invalid email only
        [TestCase("", "4324781866717289", "01/2030", "000", "USD", 1, "Invalid email")] //Empty email
        ...
        [TestCase("valid@email.com", "", "01/2030", "000", "USD", 1, "Invalid credit card number")] //Empty credit card number
        ...
        [TestCase("valid@email.com", "4324781866717289", "", "000", "USD", 1, "Invalid expiration date")] //Empty expiration date
        ...
        //Invalid cvv only
        [TestCase("valid@email.com", "4324781866717289", "01/2030", "", "USD", 1, "Invalid cvv")] //Empty cvv
        ...
        [TestCase("valid@email.com", "4324781866717289", "01/2030", "000", "AAA", 1, "Invalid or unsupported currency")] //Empty currency
        ...
        public void ValidatePayment_InvalidParameters_ThrowsArgumentException(string email, string creditCardNumber, string expirationDate, string cvv, string currency, decimal amount, string expectedErrorMessage)
        {
        ...
        [TestCase("valid@email.com", "4324781866717289", "01/2030", "000", "USD", 1)]
        public void ValidatePayment_ValidParameters_DoesNotThrowException(string email, string creditCardNumber, string expirationDate, string cvv, string currency, decimal amount)
        {
            Assert.DoesNotThrow(() => _paymentService.validatePayment(new PaymentDetails(email, creditCardNumber, expirationDate, cvv, currency, amount)));
        }
    }
}
